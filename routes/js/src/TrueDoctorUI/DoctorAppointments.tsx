...
class DoctorAppointments extends React.Component<PageProps, PageState> {
    ...
    constructor(props: PageProps) {
        ...
        this.redirectSummary = this.redirectSummary.bind(this);
        ...
        if (this.state.people.length > 0) {
            ...
            ['Patusername', pat]], null, (result: any, rr: number) => {
                if (rr === 200) {
                    ...
                    this.setState({
                        resMsg: 'failed: session not created',
                        addPatOnce: true
                    })
                }
            })
    ...
    redirectSummary() {
        if (this.state.people.length > 0) {
            this.setState({
                link: "TrueDoctorSummary/" + this.state.people[this.state.current_selection].username,
                redirectLink: true
            })
        }
    }
    ...
    render() {
        ...
        return this.state.redirectLink ? (<Redirect to={'/client/' + this.state.link} />) : (
